...
export class FormModalComponent extends BaseModal implements OnInit {
  ...
  constructor(
    ...
    // Inputs
    @Inject('titleText') public titleText: string,
    @Inject('fields') public fields: CdFormModalFieldConfig[],
    @Inject('submitButtonText') public submitButtonText: string,
    @Inject('onSubmit') public onSubmit: Function,
